      ...
      <div class="main-content-wrapper">
        ...
        <h1 class="recent-post-title"> </h1>
          ...
          <div class="post clearfix">
            <img src="assets/images/ceo.jpeg" alt="" width="300px" height="250px">
          </div>    
      </div>
      <!-- // Main Content -->

          <p>Th3 Doctor's Report is a creation for basketball lovers in East Africa.
        The idea floated in my head for the last four years. Am glad now its a reality.
        It is my hope that this baby will grow and impact the game positively.
        We are looking at highlighting the growth of the game in East Africa
        <br>
        Ariel 'Th3 Doctor' Okall 
        <br>
        CEO/OWNER
</p>
